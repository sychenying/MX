...
namespace MX2.Manager.Sys
{
    ...
    public class FTRequest
    {
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !SysConstant.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !SysConstant.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";

<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Page/Site1.Master" AutoEventWireup="true" CodeBehind="ArticleListPG.aspx.cs" Inherits="MX2.Manager.Page.ArticleListPG" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <span style="font-size: 24px;">文章管理</span>
    ...
    <script type="text/javascript">
        ...
        laypage.render({
            ...
            , jump: function (obj, first) {
                ...
                if (!first) {
                    //do something
                    location.href = "/Manager/Page/ArticleListPG.aspx?page=" + obj.curr + "&pagesize=" + obj.limit;
                }
            }
        });
        ...
        function Add() {
            location.href = "ArticlePG.aspx?type=Add";
        }
        function Edit(ID) {
            location.href = "ArticlePG.aspx?type=Edit&ID=" + ID;
        }
        function Delete(ID) {
            layer.confirm('是否删除？', {
                btn: ['确定', '取消'] //按钮

<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Page/Site1.Master" AutoEventWireup="true" CodeBehind="UserListPG.aspx.cs" Inherits="MX2.Manager.Page.UserListPG" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Add() {
            location.href = "UserPG.aspx?type=Add";
        }
        function Edit(ID) {
            location.href = "UserPG.aspx?type=Edit&ID=" + ID;
        }
        function Delete(ID) {
            layer.confirm('是否删除？', {
                btn: ['确定', '取消'] //按钮
